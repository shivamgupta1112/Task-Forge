...
const Dashboard = () => {
  ...
  const handleAddTask = async () => {
    ...
    try {
      const newTask = await api.createTask(task, deadline);
  ...
  const handleUpdateTask = async (index, title, deadline, completed) => {
    try {
      const updatedTask = await api.updateTask(tasks[index].id, title, deadline, completed);
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <Checkbox
                      ...
                      onCheckedChange={(value) =>
                        handleUpdateTask(i, t.title, t.deadline, value)
                      }
                    />
